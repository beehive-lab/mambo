...
SOURCES=elf_loader/elf_loader.o pie/pie-arm-encoder.o pie/pie-arm-decoder.o pie/pie-arm-field-decoder.o pie/pie-thumb-encoder.o pie/pie-thumb-decoder.o pie/pie-thumb-field-decoder.o dispatcher.S scanner_thumb.c scanner_arm.c common.c dbm.c traces.c syscalls.c api/emit_arm.c api/emit_thumb.c api/helpers.c api/plugin_support.c util.S

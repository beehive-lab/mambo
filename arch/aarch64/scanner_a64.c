...
size_t scan_a64(dbm_thread *thread_data, uint32_t *read_address,
  ...
  while(!stop) {
    ...
    switch (inst){
      ...
      case A64_LRCPC_1:
      case A64_LRCPC_2:
      case A64_SVE_MULT_ADD_PRED:
      case A64_SVE_ARITH_PRED:
      case A64_SVE_INT_REDUCT:
      case A64_SVE_SHIFT:
      case A64_SVE_UNARY_ARITH:
      case A64_SVE_ADD_SUB_UNPRED:
      case A64_SVE_LOG_UNPRED:
      case A64_SVE_INDEX_GEN:
      case A64_SVE_STACK_ALLOC:
      case A64_SVE2_INT_MULT_UNPRED:
      case A64_SVE_BIT_SHIFT_UNPRED:
      case A64_SVE_ADR:
      case A64_SVE_INT_MISC:
      case A64_SVE_ELEM_CNT:
      case A64_SVE_BITWISE_IMM:
      case A64_SVE_INT_WIDE_IMM_PRED:
      case A64_SVE_DUP_INDEXED:
      case A64_SVE2_DUPQ:
      case A64_SVE2_EXTQ:
      case A64_SVE2_TBL:
      case A64_SVE2_TBX:
      case A64_SVE_TBL:
      case A64_SVE2_TBQX:
      case A64_SVE_DUP_SCALAR:
      case A64_SVE_INSR_SCALAR:
      case A64_SVE2_PMOV_TO_PRED:
      case A64_SVE2_PMOV_TO_VEC:
      case A64_SVE_UNPK_UNPRED:
      case A64_SVE_INSR_SIMD:
      case A64_SVE_REV_UNPRED:
      case A64_SVE_UNPK_PRED:
      case A64_SVE_PERMUTE_PRED:
      case A64_SVE_REV_PRED:
      case A64_SVE_PERMUTE_VEC:
      case A64_SVE_CPY_SIMD:
      case A64_SVE_COMPACT:
      case A64_SVE_LAST_SCALAR:
      case A64_SVE_LAST_SIMD:
      case A64_SVE_REV_ELEM:
      case A64_SVE_CPY_SCALAR:
      case A64_SVE_CLAST_PRED:
      case A64_SVE_CLAST_SIMD_PRED:
      case A64_SVE_SPLICE_CON:
      case A64_SVE_SPLICE_DES:
      case A64_SVE2_REVD:
      case A64_SVE_CLAST_GEN_REG:
      case A64_SVE_SEL:
      ...
      case A64_SVE_PTRUE:
      case A64_SVE_RDFFR:
      case A64_SVE_RDFFR_UNPRED:
      case A64_SVE_INT_CMP_SCALAR:
      case A64_SVE2_BROADCAST_PRED:
      case A64_SVE2_PEXT:
      case A64_SVE2_PTRUE:
      case A64_SVE2_WHILE_PAIR:
      case A64_SVE2_WHILE_CNTR:
      case A64_SVE_INT_WIDE_IMM:
      case A64_SVE2_PRED_CNT:
      case A64_SVE_INC_DEC_PRED_CNT:
      case A64_SVE_WRFFR:
      case A64_SVE_SETFFR:
      ...
      case A64_SVE2_TWO_DOT_INDEX:
      case A64_SVE2_INT_ARITH:
      case A64_SVE2_SHLL:
      case A64_SVE2_ADD_SUB_L:
      case A64_SVE2_EORTB:
      case A64_SVE_MMLA:
      case A64_SVE2_BITPERM:
      case A64_SVE2_ACCUM:
      case A64_SVE2_NARROW:
      case A64_SVE2_MATCH:
      case A64_SVE2_HISTSEG:
      case A64_SVE2_HISTCNT:
      case A64_SVE2_CRYPTO:
      case A64_SVE_FCMLA_VEC:
      case A64_SVE_FCADD:
      case A64_SVE_FCVT_ODD:
      case A64_SVE2_FPAIRWISE:
      case A64_SVE2_FREC_QUAD:
      case A64_SVE_FMLA:
      case A64_SVE_FCMLA:
      case A64_SVE_FMUL:
      ...
      case A64_SVE_FRINT:
      case A64_SVE_FCVT:
      case A64_SVE_FRECPX_FSQRT:
      case A64_SVE_INT_FCVT:
      case A64_SVE_FCVT_INT:
      case A64_SVE_REDUC:
      case A64_SVE_UNARY_UNPRED:
      case A64_SVE_FCMP_ZERO:
      case A64_SVE_FADDA:
      case A64_SVE_FNMLA_D:
      case A64_SVE_32_GATHER:
      case A64_SVE_CONT_LOAD:
      case A64_SVE_64_GATHER:
      case A64_SVE_CONT_STORE:
      case A64_SVE_NTMP_QUAD:
      case A64_SVE_NTMP_CONT:
      case A64_SVE_SCATTER_SIGN:
      case A64_SVE_SCATTER:
